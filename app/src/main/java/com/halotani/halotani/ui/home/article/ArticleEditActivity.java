...
import com.halotani.halotani.databinding.ActivityArticleEditBinding;
...
public class ArticleEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityArticleEditBinding.inflate(getLayoutInflater());
        ...
        if(model.isFavorite()) {
            isFavorite = true;
            binding.artikelPilihan.setChecked(true);
        } else {
            isFavorite = false;
            binding.artikelPilihan.setChecked(false);
        }
        ...
        binding.imageHint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ImagePicker.with(ArticleEditActivity.this)
                        .galleryOnly()
                        .compress(1024)
    ...
    private void updateArticle() {
        ...
        if(title.isEmpty()) {
            Toast.makeText(ArticleEditActivity.this, "Judul Artikel tidak boleh kosong", Toast.LENGTH_SHORT).show();
            return;
        }
        else if(description.isEmpty()) {
            Toast.makeText(ArticleEditActivity.this, "Deskripsi Artikel tidak boleh kosong", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void showFailureDialog() {
        new AlertDialog.Builder(this)
                .setTitle("Gagal memperbarui artikel")
                .setMessage("Terdapat kesalahan ketika memperbarui artikel, silahkan periksa koneksi internet anda, dan coba lagi nanti")
    ...
    private void showSuccessDialog() {
        new AlertDialog.Builder(this)
                .setTitle("Berhasil memperbarui artikel")
                .setMessage("Artikel akan segera terbit, sukses mengedit artikel")
    ...
    private void uploadArticleDp(ArticleEditActivity activity, Uri data) {
